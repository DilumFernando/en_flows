...
log_file_2 = f"{data}_logs/training_log_normalized_inner_n_data_{n_data}_0.txt"  
plot_file = f"training_losses_normalized_{n_data}_0.png"  
...
pattern = re.compile(r"Mean Train NLL: (-?[\d.]+)")
...
plt.plot(mean_train_losses_2, marker='x', linestyle='--', color='r', label='inner product based - Mean Train NLL')
plt.xlabel('Epochs')
